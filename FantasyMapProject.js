                ...
                if (this.Map != null && Bridge.is(e, TouchEvent)) {
                    ...
                    if (te != null && te.touches != null) {
                        if (te.touches.length === 1) {
                            ...
                            this.LastPinchGestureDistance = distance;
                            this.Map.ZoomMap(mid.x, mid.y, delta * Web.App.ZOOM_SPEED);
                        }
                    }
                }
            }
